...
const Pricing = () => {
    ...
    const filteredData = names.filter((item) => item.category.includes(selectedCategory));
                    ...
                    {filteredData.map((item, index) => (
                        ...
                        >
                            ...
                            <h2 className="text-4xl sm:text-5xl font-semibold text-midnight_text mb-3 group-hover:text-white">
                                ${selectedCategory === "monthly" ? item.price.monthly : item.price.yearly}/<span className="text-lightgrey">mo</span>
                            </h2>
