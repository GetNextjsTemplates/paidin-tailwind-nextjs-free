            ...
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                    <div className='col-span-6 flex flex-col justify-center'>
                        ...
                        <Link href={'/'} className="text-primary hover:text-blue-700 text-lg font-medium flex items-center gap-2 pt-4 mx-auto lg:mx-0 w-fit">
                            Learn more
                            <Icon
                    ...
                    <div className='col-span-6 flex justify-center mt-10 lg:mt-0'>
                        <Image src="/images/business/business.png" alt="business" width={1000} height={805} />
                    </div>
                </div>
            </div>
        </section>
