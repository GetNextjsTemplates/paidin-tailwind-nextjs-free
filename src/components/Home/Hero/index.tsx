      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        <div className='grid grid-cols-1 lg:grid-cols-12'>
          <div className='col-span-7 flex flex-col justify-evenly relative'>
            <Image src="/images/hero/star.svg" alt="star-image" width={95} height={97} className='absolute top-[-74px] right-[51px]' />
            <Image src="/images/hero/lineone.svg" alt="line-image" width={190} height={148} className='absolute top-[-74px] right-[51px]' />
            <h1 className='text-midnight_text text-4xl md:text-86 text-center lg:text-start font-semibold pt-5'>Put an end to unpaid invoices.</h1>
          ...
          <div className='col-span-5 flex justify-center xl:-mb-32 xl:-mr-32 pt-10 lg:pt-0'>
            <Image src="/images/hero/banner.png" alt="nothing" width={1000} height={805} />
          </div>
        </div>
      </div>
    </section>
